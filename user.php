...
<body>
 <nav> 
     ...
     <ul> 
         <li><a href="login.php" class= "btn btn-primary">login as user</a></li>
    </ul>
     ...
     <center>
      ...
      <!-- i want to give colour to my error messages, ask br morayo about it -->
  ...
  <div class="section1">
    ...
    <img class= "main_img" src="picture/3.png">
  </div>
